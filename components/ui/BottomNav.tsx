...
export default function BottomNav() {
  ...
  return (
    <div style={{ position: 'absolute', left: 0, right: 0, bottom: 0, zIndex: 6, display: 'flex', justifyContent: 'space-around', alignItems: 'center', padding: '14px 24px 14px', background: 'rgba(255,255,255,0.92)', borderTop: '1px solid #EFE8DE', backdropFilter: 'blur(12px)' }}>
